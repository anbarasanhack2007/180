                          ...
                          child: ExpansionTile(
                            leading: Container(
                              ...
                              child: Center(
                                child: Text(
                                  'M${m.monthNumber}',
                                  style: const TextStyle(color: AppColors.cyberCyan, fontWeight: FontWeight.bold, fontSize: 13),
                                ),
                              ),
                            ),
                            title: Text(
                            ...
                            children: [
                              ...
                              const Text(
                                'KEY OBJECTIVES:',
                                style: TextStyle(color: AppColors.cyberCyan, fontSize: 11, fontWeight: FontWeight.bold, letterSpacing: 1.0),
                              ),
                              const SizedBox(height: 6),
                              ...m.objectives.map((obj) => Padding(
                                    ...
                                    child: Row(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        const Text('• ', style: TextStyle(color: AppColors.cyberCyan)),
                                        Expanded(child: Text(obj, style: const TextStyle(color: AppColors.textSecondary, fontSize: 12))),
                                      ],
                                    ),
                                  )),
                              const SizedBox(height: 12),
                                  ...
                                  OutlinedButton.icon(
                                    onPressed: () {
                                      ScaffoldMessenger.of(context).showSnackBar(
                                        SnackBar(content: Text('Month ${m.monthNumber} schedule synced with cloud')),
                                      );
                                    },
                                    icon: const Icon(Icons.sync, size: 14),
                                    label: const Text('Sync Missions', style: TextStyle(fontSize: 12)),
